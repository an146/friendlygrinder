...
function MultiSelector(list_target, max) {
  ...
  this.addElement = function( element ){if( element.tagName == 'INPUT' && element.type == 'file' ){element.name = 'attachment[file_' + (this.id++) + ']';
  ...
  this.addListRow = function( element ){var new_row = document.createElement('li');
